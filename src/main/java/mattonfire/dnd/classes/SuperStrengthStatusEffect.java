...
public class SuperStrengthStatusEffect extends StatusEffect {
    ...
    // This method is called every tick to check weather it should apply the status
    // effect or not
    @Override
    ...
    // This method is called when it applies the status effect. We implement custom
    // functionality here.

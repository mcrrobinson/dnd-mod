...
public class GUI extends LightweightGuiDescription {
    ...
    public GUI () {
        ...
        WLabel label = new WLabel(new LiteralText("Classes"), 0xFFFFFF);
        root.add(label, 0, 0, 2, 1);
        
        // Wizard Class.
        WButton wizard_button = new WButton(new TranslatableText("Wizard"));
        ...
        // Barbarian
        WButton barbarian_button = new WButton(new TranslatableText("Barbarian"));
        ...
        // Rogue Class.
        WButton rogue_button = new WButton(new TranslatableText("Rogue"));
        ...
        // Bard
        WButton bard_button = new WButton(new TranslatableText("Bard"));
        ...
        // Cleric
        WButton cleric_button = new WButton(new TranslatableText("Cleric"));
        ...
        // Druid
        WButton druid_button = new WButton(new TranslatableText("Druid"));
        ...
        // Fighter
        WButton fighter_button = new WButton(new TranslatableText("Fighter"));
        ...
        // Monk
        WButton monk_button = new WButton(new TranslatableText("Monk"));
        ...
        // Paladin
        WButton paladin_button = new WButton(new TranslatableText("Paladin"));
        ...
        // Ranger
        WButton ranger_button = new WButton(new TranslatableText("Ranger"));
        ...
        // Necromancer
        WButton necromancer_button = new WButton(new TranslatableText("Necromancer"));
        ...
        // Warlock
        WButton warlock_button = new WButton(new TranslatableText("Warlock"));
        ...
        // Artificer
        WButton artificer_button = new WButton(new TranslatableText("Artificer"));
        ...
        // Ranger
        WButton blood_hunter_button = new WButton(new TranslatableText("Blood Hunter"));
        ...
        // Alchemist
        WButton alchemist_button = new WButton(new TranslatableText("Alchemist"));
        ...
        druid_button.setOnClick(()->{
            // Buff: Every taiimed animal adds a heart (capped at 5). Regen in the light even when not full of food.
        ...
        alchemist_button.setOnClick(()->{
            // Buff: Craft special potions. e.g. Mob fight mob potion. Anxiety Potion. Immune to poison and wither.
